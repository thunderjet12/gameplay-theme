 ...
 * @returns {object}
 */
const flattenVariables: any = (variables, prefix) => {
 ...
 * @returns {string}
 */
const getFlatVariablesSass: any = (variables) => {
 ...
 * @returns {string}
 */
module.exports = function ( rawConfig : any ) {
  ...
  if (typeof options.sassOutput !== 'undefined') {
    ...
    this._module.reasons.forEach(( reason: any ) => {
